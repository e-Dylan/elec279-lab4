...
public class HourlyEmployee extends Employee
    ...
    public Double amountToPay() {
        // calculate total amount to pay for all hours worked
        return getPay();
    }

    public void printPayment() {
        System.out.println("Payment information for an hourly employee. Employee name: " + this.getName()
                + "; payment: " + amountToPay());
    }

    public int compareTo(HourlyEmployee anotherWorker) {
        // return: -1 if comes before, 0 if equal, 1 if after
        return super.getName().compareTo(anotherWorker.getName());
    }
